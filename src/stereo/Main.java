...
import stereo_praha.gui.PlaceOfRealAction;
...
{  
    ...
    public static void links()
    {
        ...
        try
        {
           img1 = ImageIO.read(new File("./koberec1.jpg"));
           img2 = ImageIO.read(new File("./koberec2.jpg"));
        } catch(IOException e)
        {
            e.printStackTrace();
            return;
        ...
        final ArrayList<FtrLink> links = perfect1.findLinks_withProxymity(perfect2);
...
//        frame.getContentPane().add(new JLabel(new ImageIcon(img)));
    ...
    public static void manual()
    {
        ...
        try
        {
           img1 = ImageIO.read(new File("./rieka1.jpg"));
           img2 = ImageIO.read(new File("./rieka2.jpg"));
        } catch(IOException e)
        {
            e.printStackTrace();
            return;
